...
int main()
{
    ...
    sf::Image icon_image;
    icon_image.loadFromFile("../Resources/Images/icon.png");
    ...
    start_texture.loadFromFile("../Resources/Images/StartScreen.png");

    sf::Sprite start_sprite;
    start_sprite.setTexture(start_texture);

    sf::Texture startfont_texture;
    startfont_texture.loadFromFile("../Resources/Images/Font.png");
    ...
    explosion_buffer.loadFromFile("../Resources/Music/explosion.wav");
    ...
    laser_buffer.loadFromFile("../Resources/Music/laser.wav");

    sf::Sound laser_sound;
    laser_sound.setBuffer(laser_buffer);

    sf::Music music;
    music.openFromFile("../Resources/Music/music.wav");
    music.setLoop(true);
    music.play();
    music.setVolume(30);
    ...
    controlicon_image.loadFromFile("../Resources/Images/icon.png");
    ...
    control_texture.loadFromFile("../Resources/Images/ControlScreen.png");

    sf::Sprite control_sprite;
    control_sprite.setTexture(control_texture);

    sf::Texture controlfont_texture;
    controlfont_texture.loadFromFile("../Resources/Images/Font.png");
    ...
    icongame_image.loadFromFile("../Resources/Images/icon.png");
